    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Drones",
                columns: new[] { "Id", "BatteryCapacity", "DroneId", "Model", "SerialNumber", "State", "WeightLimit" },
                values: new object[,]
                {
                    { 1, 90.0, null, 2, "DR001", 0, 450.0 },
                    { 2, 95.0, null, 3, "DR002", 5, 400.0 },
                    { 3, 80.0, null, 0, "DR003", 2, 300.0 },
                    { 4, 92.0, null, 1, "DR004", 4, 320.0 },
                    { 5, 90.0, null, 1, "DR005", 3, 280.0 },
                    { 6, 98.0, null, 3, "DR006", 2, 440.0 },
                    { 7, 85.0, null, 2, "DR007", 0, 500.0 }
                });
